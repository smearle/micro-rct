...
if __name__ == '__main__':
    ...
    happiness2 = A2C(MlpPolicy, env, learning_rate = 1e-5, tensorboard_log=tb_logs, verbose=1)

    callback = CheckpointCallback(save_freq = int(1e6), save_path = model_dir)

    try:
      happiness2.learn(total_timesteps=int(1e8), callback = callback)
      happiness2.save("./happiness2")

...
from stable_baselines3.a2c.policies import MlpLstmPolicy
...
if __name__ == '__main__':
    ...
    mlplstm1= A2C(MlpLstmPolicy, env, n_steps = 500, tensorboard_log=tb_logs, verbose=1)

    callback = CheckpointCallback(save_freq = int(1e6), save_path = model_dir)

    try:
      mlplstm1.learn(total_timesteps=int(1e8), callback = callback)
      mlplstm1.save("./tmp/lstm-mlp1")

...
from stable_baselines3.common.policies import DropoutCnnPolicy
...
if __name__ == '__main__':
    ...
    cnn= A2C(DropoutCnnPolicy, env, learning_rate = 1e-5, tensorboard_log=tb_logs, verbose=1)

    callback = CheckpointCallback(save_freq = int(4.2e5), save_path = model_dir)

    try:
      cnn.learn(total_timesteps=int(1e8), callback = callback)
      cnn.save("./tmp/model")
